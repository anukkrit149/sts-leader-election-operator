...
run: manifests generate fmt vet ## Run a controller from your host.
	go run ./cmd/main.go --metrics-bind-address=:8080 --metrics-secure=false --health-probe-bind-address=:8081
...
docker-buildx: ## Build and push docker image for the manager for cross-platform support
	...
	- $(CONTAINER_TOOL) buildx create --name sts-leader-elect-operator-builder
	$(CONTAINER_TOOL) buildx use sts-leader-elect-operator-builder
	- $(CONTAINER_TOOL) buildx build --push --platform=$(PLATFORMS) --tag ${IMG} -f Dockerfile.cross .
	- $(CONTAINER_TOOL) buildx rm sts-leader-elect-operator-builder
	rm Dockerfile.cross
